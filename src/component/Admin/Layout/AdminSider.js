      ...
      <div>
        ...
        >
          ...
          >
            ...
            <SubMenu key="category" title={<div className="d-flex align-items-center"> <Icon type="deployment-unit" /><div>Categorys </div></div>} >
            ...
            <SubMenu key="jobs" title={<div className="d-flex align-items-center"> <Icon type="appstore" /><div>Jobs </div></div>} >
