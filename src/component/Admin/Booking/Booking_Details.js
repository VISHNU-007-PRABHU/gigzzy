                                    ...
                                    <Row gutter={[12, 12]}>
                                        <Col md={12} sm={24}>
                                            <div className="d-block in_card">
                                                ...
                                                {/* <div className="in_card_spilt overflow-auto my-5" style={{ height: '18em' }}>
                                                    {booking[0] ? booking[0].start_job_image_url.map(data => (<>
                                                        <img src={data} className="w-100" style={{ height: "20em" }} />
                                                    </>
                                                    )) : ""}
                                                </div> */}
                                            </div>
                                        ...
                                        <Col md={12} sm={24}>
                                            <div className="d-block in_card">
                                                ...
                                                {/* <div className="in_card_spilt overflow-auto my-5" style={{ height: '18em' }}>
                                                    {booking[0] ? booking[0].end_job_image_url.map(data => (<>
                                                        <img src={data} className="w-100" style={{ height: "20em" }} />
                                                    </>
                                                    )) : ""}
                                                </div> */}
