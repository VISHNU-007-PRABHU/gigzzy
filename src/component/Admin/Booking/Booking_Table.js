...
class BookingTable extends React.Component {
    ...
    fetch_booking = async (data) => {
        ...
        await client.query({
            ...
            this.setState({ loading: 0, pagination, dataSource: result.data.get_booking.data });
        });
    }
    ...
    handleTableChange = async pagination => {
        ...
        this.setState({ loading: 1 });
        var input = { ...this.state.input_data, limit: pager.pageSize, page: pager.current, booking_status: [13, 10] }
        await client.query({
            query: GET_BOOKING,
            variables: input,
            fetchPolicy: 'no-cache',
            ...
            this.setState({ pagination, loading: 0, dataSource: result.data.get_booking.data });
        });
    };
...
export default Form.create()(withRouter(BookingTable))