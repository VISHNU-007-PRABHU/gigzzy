...
var userbidingSchema = new Schema({
...
userbidingSchema.virtual('uid').get(function () {
  return this._id;
});

userbidingSchema.pre('save', function (next, doc) {
...
userbidingSchema.virtual('user_image_url').get(function () {
...
userbidingSchema.virtual('start_job_image_url').get(function () {
...
userbidingSchema.virtual('end_job_image_url').get(function () {
...
userbidingSchema.virtual('created_date').get(function () {
  var created_date = moment(this.created_at);
  return created_date.format('DD/MM/YYYY');
});

userbidingSchema.virtual('bookingDate').get(function () {
...
userbidingSchema.virtual('job_start_time').get(function () {
...
userbidingSchema.virtual('lat').get(function () {
  if (this.location.coordinates) {
    return this.location.coordinates[1];
  }
});
userbidingSchema.virtual('lng').get(function () {
  if (this.location.coordinates) {
    return this.location.coordinates[0];
  }
});

userbidingSchema.virtual('job_end_time').get(function () {
  if (this.jobEnd_time) {
...
userbidingSchema.virtual('actual_time').get(function () {
...
var userbiding = mongoose.model('userbiding', userbidingSchema);
module.exports = userbiding;
