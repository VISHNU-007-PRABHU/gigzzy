...
const typeDefs = gql `
    ...
    type Mutation {
        ...
        manage_booking(role:Int,booking_id:ID,user_id:ID,provider_id:ID,category_id:String,lat:Float,lng:Float,weekday:JSON,hours:String,description:String,booking_status:Int,category_type:Int,stripe_token:String,extra_fare:String,extra_fare_reason:String,option:Int,extra_fare_id:ID):[Booking]
